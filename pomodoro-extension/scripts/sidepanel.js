...
const DRAG_HANDLE_SVG = `<svg viewBox="0 0 24 24" width="26" height="26" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  <path d="M4 15V13H20V15H4ZM4 11V9H20V11H4Z" fill="currentColor"/>
</svg>`;

const DELETE_SVG = `<svg viewBox="0 0 24 24" width="26" height="26" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
